...
const NutritionAnalysis=()=> {
  ...
  const analyzeNutrition = () => {
    ...
    const appId = '63681832';
    const appKey = '5cc390870c4af0f76ab63036615c17b7';
    const encodedIngredients = encodeURIComponent(ingredients);
    fetch(
      `https://api.edamam.com/api/nutrition-data?app_id=${appId}&app_key=${appKey}&ingr=${encodedIngredients}`
    )
